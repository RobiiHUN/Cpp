...
//getI
double Resistor::getI(double fesz)const{return fesz/R;}

//getu
double Resistor::getU(double arer)const{return arer * R;}
...
//egyenloseg op
Resistor& Resistor::operator=(const Resistor& ellenallas){
    R = ellenallas.R;
    return *this;
}
