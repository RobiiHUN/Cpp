...
int main() {
  ...
  Resistor r1(1000), r2(3000);    //explicit. ctor
  ...
  TEST(ResistorTest, getU) {				// getU
    const Resistor r0(12.12);   //param ctor
  ...
  TEST(ResistorTest, EQ) {				    // operator==
    const Resistor r0(12345.6789);     //param ctor
    const Resistor r1(123456789);       //param ctor       // r1 ez pont a 10-szerese r0-nak
    ...
    const Resistor r3(1e-18);      //param ctor            // kis értéknél hogy viselkedik?
  ...
  TEST(ResistorTest, Inserter) {
    ...
    oss << Resistor(8.45) << '\t' << Resistor(100);     //param ctor 2x
